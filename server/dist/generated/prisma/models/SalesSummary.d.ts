...
export type SalesSummaryWhereInput = {
    ...
    summaryId?: Prisma.StringFilter<"SalesSummary"> | string;
    totalValue?: Prisma.FloatFilter<"SalesSummary"> | number;
    changPercentage?: Prisma.FloatNullableFilter<"SalesSummary"> | number | null;
...
export type SalesSummaryOrderByWithRelationInput = {
    ...
    changPercentage?: Prisma.SortOrderInput | Prisma.SortOrder;
...
export type SalesSummaryScalarWhereWithAggregatesInput = {
    ...
    summaryId?: Prisma.StringWithAggregatesFilter<"SalesSummary"> | string;
    totalValue?: Prisma.FloatWithAggregatesFilter<"SalesSummary"> | number;
    changPercentage?: Prisma.FloatNullableWithAggregatesFilter<"SalesSummary"> | number | null;
...
export type SalesSummaryUpdateInput = {
    ...
    changPercentage?: Prisma.NullableFloatFieldUpdateOperationsInput | number | null;
...
export type SalesSummaryCountOrderByAggregateInput = {
    summaryId?: Prisma.SortOrder;
    totalValue?: Prisma.SortOrder;
    changPercentage?: Prisma.SortOrder;
    date?: Prisma.SortOrder;
};
...
export type SalesSummaryOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"summaryId" | "totalValue" | "changPercentage" | "date", ExtArgs["result"]["salesSummary"]>;
...
export interface SalesSummaryDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const salesSummaryWithSummaryIdOnly = await prisma.salesSummary.findMany({ select: { summaryId: true } })
     *
     */
     ...
     * })
     *
     * // Create many SalesSummaries and only return the `summaryId`
     * const salesSummaryWithSummaryIdOnly = await prisma.salesSummary.createManyAndReturn({
     ...
     * })
     *
     * // Update zero or more SalesSummaries and only return the `summaryId`
     * const salesSummaryWithSummaryIdOnly = await prisma.salesSummary.updateManyAndReturn({
     *   select: { summaryId: true },
     *   where: {
     *     // ... provide filter here
     *   },
...
export interface SalesSummaryFieldRefs {
    readonly summaryId: Prisma.FieldRef<"SalesSummary", 'String'>;
    readonly totalValue: Prisma.FieldRef<"SalesSummary", 'Float'>;
    readonly changPercentage: Prisma.FieldRef<"SalesSummary", 'Float'>;
