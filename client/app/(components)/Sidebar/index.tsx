...
const Sidebar = () => {
    ...
    const sidebarClassName = `flex flex-col fixed ${isSidebarCollapsed ? "w-0  md:w-16" : "w-72 md:w-64"} bg-white transition-all duration-300 overflow-hidden h-full shadow-md z-40`
    ...
    <div className={sidebarClassName}>
        ...
        {/*LINKS */}
            <div className='flex-grow mt-8'>
                ...
                <SidebarLink href='/expanses' icon={CircleDollarSign} label="Expanses" isCollapsed={isSidebarCollapsed}/>
